...
import CollegeCardForCompany from '@/components/Cards/College/CollegeCardForCompany'
...
export default function CollegesPage() {
    ...
    const handleViewDetails = (id) => {
        router.push(`/company/college/${id}`)
    }
        ...
        <div className="flex flex-col space-y-4 p-4">
            ...
            <div className='flex flex-col space-y-6 pb-4'>
                { collegesData?.map((college)=> 
                    <CollegeCardForCompany key={college.id} id={college.id} name={college.name} city={college.city}
