...
import { getCompanyProfile, updateCompanyProfile } from "@/services/profile.service"

import CompanyProfileEdit from "@/components/Profile/Company/CompanyProfileEdit"
...
export default function ProfileCompany() {
    ...
    useEffect(() => {
        user?.id && getCompanyProfile({id:user?.id, setprofileData: setprofileData, seterror: seterror}) 
    }, [user])
    ...
    const onSubmit = async (data) => {
        await updateCompanyProfile({id:user?.id, data: data, seterror: seterror, setloading: setloading})
    }
    ...
    return (
        <div className='flex flex-col space-y-4 items-center pt-4 pb-20 bg-zinc-900'>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col space-y-4'>
                ...
                <CompanyProfileEdit register={register} errors={errors}/> 
...
ProfileCompany.getLayout = function getLayout(page) {
    return (
      <CompanyLayout>
            {page}
      </CompanyLayout>
