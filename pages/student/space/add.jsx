...
export default function AddNewSpaceStudent() {
    ...
    const onSubmit = async (data) => {
        ...
        await addSpace({data: data, setloading: setloading, seterror: seterror, router: router, type: 'student'})
    }
...
AddNewSpaceStudent.getLayout = function getLayout(page) {
    return (
      <StudentLayout headerX={{close: '/student/space'}} notShowFooter={true} notShowHeader={true}>
        {page}
      </StudentLayout>
    )
}